...
echo ${C}"LXDE [2] - Light -- Recommended"
echo ${C}"LXQT [3] - Light"
...
echo 'bash "/root/DAMOS_GUI_INSTALL.sh"' >> '/data/data/com.termux/files/usr/var/lib/proot-distro/installed-rootfs/damos/root/.bashrc'
...
BANNER_RCM
echo " "
echo "				[1] File Editor				[2] Calculator"
}
