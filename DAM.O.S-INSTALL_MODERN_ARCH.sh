...
# To Bind A Directory Please type " --bind /ENTER/FILEPATH:/ENTER/SAME_FILEPATH " on " * ) DAMOS-STANDALONE="--no-sysvipc --shared-tmp";; "
# Example " * ) DAMOS-STANDALONE="--no-sysvipc --shared-tmp --bind /storage/7B1A-274B:/storage/7B1A-274B";; "
...
echo "		-s, --standalone	Will Unbind Dam.OS the Majority of itself From your Android System"
...
yes | apt install figlet toilet proot-distro llvm wget curl virglrenderer-android xwayland tigervnc xorg-xhost termux-x11-nightly pulseaudio -y
yes | apt upgrade -y
if [ -f '/data/data/com.termux/files/usr/var/lib/proot-distro/installed-rootfs/damos/root' ]; then echo ${R}"A Current Dam.OS Distro Is Installed! Resetting..."${W}; sleep 1.8; RESET_INSTALLED_DAMOS_SYSTEM; else proot-distro install archlinux --override-alias damos; fi
proot-distro clear-cache
INSTALL_KERNEL_SCRIPT_${GUI_CHOICE}
}

function RESET_INSTALLED_DAMOS_SYSTEM (){
rm -rf /data/data/com.termux/files/usr/bin/damos
rm -rf /data/data/com.termux/files/usr/var/lib/proot-distro/installed-rootfs/damos

proot-distro reset damos
}
...
yes | pacman -Syu
yes | pacman -Syy sudo
pacman -S plasma-desktop tar sed llvm sl wget curl php python3 mesa-utils plasma kdeconnect chromium firefox pulseaudio zenity konsole dbus base-devel dolphin -y --noconfirm
yes | pacman -Syu
yes | pacman -Syy
...
yes | pacman -Syu
yes | pacman -Syy sudo
pacman -S xfce4 xfce4-goodies tar sed llvm sl wget curl php python3 mesa-utils kdeconnect chromium firefox pulseaudio zenity gnome-terminal dbus base-devel dolphin -y --noconfirm
yes | pacman -Syu
yes | pacman -Syy
rm -rf '/root/DAMOS_GUI_INSTALL.sh'
rm -rf '/root/.bash_profile'
...
yes | pacman -Syu
yes | pacman -Syy sudo
pacman -S sl wget tar sed curl php python3 pulseaudio dbus base-devel -y --noconfirm
yes | pacman -Syu
yes | pacman -Syy
rm -rf '/root/DAMOS_GUI_INSTALL.sh'
rm -rf '/root/.bash_profile'
...
yes | pacman -Syu
yes | pacman -Syy sudo
pacman -S lxde lxdm tar sed llvm sl wget curl php python3 mesa-utils chromium firefox pulseaudio gnome-terminal zenity dbus base-devel dolphin -y --noconfirm
yes | pacman -Syu
yes | pacman -Syy
rm -rf '/root/DAMOS_GUI_INSTALL.sh'
rm -rf '/root/.bash_profile'
...
yes | pacman -Syu
yes | pacman -Syy sudo
pacman -S lxqt kdeconnect tar sed llvm sl wget curl php python3 mesa-utils chromium firefox pulseaudio gnome-terminal zenity dbus base-devel dolphin -y --noconfirm
yes | pacman -Syu
yes | pacman -Syy
rm -rf '/root/DAMOS_GUI_INSTALL.sh'
rm -rf '/root/.bash_profile'
...
yes | pacman -Syu
yes | pacman -Syy sudo
pacman -S mate mate-extra tar sed llvm sl wget curl php python3 mesa-utils kdeconnect chromium firefox pulseaudio zenity gnome-terminal dbus base-devel dolphin -y --noconfirm
yes | pacman -Syu
yes | pacman -Syy
rm -rf '/root/DAMOS_GUI_INSTALL.sh'
rm -rf '/root/.bash_profile'
...
cat > /data/data/com.termux/files/usr/bin/damos-rcm
cat <<-EOF> /data/data/com.termux/files/usr/bin/damos-rcm
#!/data/data/com.termux/files/usr/bin/bash
...
exit 1' >> /data/data/com.termux/files/usr/var/lib/proot-distro/installed-rootfs/damos/root/DAMOS_GUI_INSTALL.sh
...
mkdir wallpapers
cd wallpapers
curl -o DAM.OS-WALLPAPER.jpg https://github.com/SMGXSCRIPTS/Dam.OS/raw/main/lib/DAM.OS-WALLPAPER.jpg
curl -o DAM.OS-WALLPAPER-2.jpg https://github.com/SMGXSCRIPTS/Dam.OS/raw/main/lib/DAM.OS-WALLPAPER-2.jpg
curl -o DAM.OS-WALLPAPER-3.jpg https://github.com/SMGXSCRIPTS/Dam.OS/raw/main/lib/DAM.OS-WALLPAPER-3.jpg
curl -o DAM.OS-WALLPAPER-4.jpg https://github.com/SMGXSCRIPTS/Dam.OS/raw/main/lib/DAM.OS-WALLPAPER-4.jpg
curl -o DAM.OS-WALLPAPER-5.jpg https://github.com/SMGXSCRIPTS/Dam.OS/raw/main/lib/DAM.OS-WALLPAPER-5.jpg
curl -o DAM.OS-WALLPAPER-6.jpg https://github.com/SMGXSCRIPTS/Dam.OS/raw/main/lib/DAM.OS-WALLPAPER-6.jpg
