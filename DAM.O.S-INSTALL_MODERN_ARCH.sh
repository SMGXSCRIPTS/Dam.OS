...
function STANDALONE (){
proot-distro login damos --shared-tmp --fix-low-ports
}
...
wget https://github.com/xDoge26/proot-setup/raw/main/box86_64.sh; bash box86_64.sh; rm box86_64.sh' >> /data/data/com.termux/files/usr/var/lib/proot-distro/installed-rootfs/damos/root/.bash_profile
}
